...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "62900000", cli1, c2);
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PEDIDO, ped2, sdf.parse("20/10/2020 00:00"),
				null);
